...
import { cancelFeedback, submitJamedaFeedback } from '../actions';
...
/**
 * The type of the React {@code Component} props of {@link JamedaFeedbackDialog}.
 */
type Props = {
...
/**
 * The type of the React {@code Component} state of {@link JamedaFeedbackDialog}.
 */
type State = {
 ...
 * @extends Component
 */
class JamedaFeedbackDialog extends Component<Props, State> {
    /**
    ...
    _onSubmit() {
        ...
        dispatch(submitJamedaFeedback(scoreToSubmit, message, conference));
...
export default translate(connect(_mapStateToProps)(JamedaFeedbackDialog));
